...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-fit   sm:min-h-[678px]">
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center justify-around mx-auto min-h-[600px] lg:min-h-[948px] h-full gap-8">
          ...
          <div className="col-span-2 h-full flex flex-col justify-center items-start text-white text-right pr-0 lg:pr-8">
            ...
            <AnimatedSection
              ...
              className="mb-6"
            >
              <h1 className="max-w-full lg:max-w-[1087px] font-bold text-[32px] sm:text-[48px] lg:text-[64px] leading-[40px] sm:leading-[70px] lg:leading-[131px] text-right text-white">
