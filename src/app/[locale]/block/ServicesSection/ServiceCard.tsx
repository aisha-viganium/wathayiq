...
export default function ServiceCard({ service, isArabic }: Props) {
  return (
    <div
      className={`flex flex-row justify-end items-start p-[8px] md:p-4 gap-[8px] md:gap-[16px] min-h-[78px]   bg-[#F9FCFF] border border-[#0D8083] rounded-[8px] md:rounded-[8px] group duration-300 hover:bg-[#283F3E] ${isArabic ? "2xl:min-h-[135px] md:min-h-[175px]" : "2xl:min-h-[200px] md:min-h-[255px]"}`}
    >
